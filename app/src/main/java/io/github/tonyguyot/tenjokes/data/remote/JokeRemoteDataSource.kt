 ...
 */
class JokeRemoteDataSource(private val service: RestJokeService) : BaseRemoteDataSource() {

    suspend fun fetchNewJokes(): Resource<List<Joke>> =
        fetchResource { service.getTenRandomJokes() }
}